    ...
    <div class="container">
        <div class="row g-4 justify-content-between">
            ...
            <div class="col-lg-4 col-md-6">
                <h5 class="fw-bold text-success mb-3"> Store</h5>
                <p class="text-white-50 small mb-3">
                    Your ultimate destination for top-quality electronics, fashion, and lifestyle products with a seamless shopping experience.
                </p>
            ...
            <div class="col-lg-2 col-md-6">
                <h5 class="fw-bold mb-3 fs-6">Quick Links</h5>
                <ul class="list-unstyled d-flex flex-column gap-2 small">
                    <li><a href="#" class="text-white-50 text-decoration-none hover-white">Home</a></li>
                    <li><a href="#" class="text-white-50 text-decoration-none hover-white">Products</a></li>
                    <li><a href="#" class="text-white-50 text-decoration-none hover-white">About Us</a></li>
                    <li><a href="#" class="text-white-50 text-decoration-none hover-white">Contact Us</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled d-flex flex-column gap-2 small">
                    <li><a href="#" class="text-white-50 text-decoration-none hover-white">Electronics</a></li>
                    <li><a href="#" class="text-white-50 text-decoration-none hover-white">Fashion</a></li>
                    <li><a href="#" class="text-white-50 text-decoration-none hover-white">Accessories</a></li>
                    <li><a href="#" class="text-white-50 text-decoration-none hover-white">New Arrivals</a></li>
                </ul>
            </div>

            <!-- Newsletter / Contact Info -->
            <div class="col-lg-4 col-md-6">
                <h5 class="fw-bold mb-3 fs-6">Stay Connected</h5>
                <p class="text-white-50 small mb-3">Subscribe to our newsletter to get the latest updates and offers.</p>
                <form action="" method="POST" class="d-flex gap-2">
                    <input type="email" class="form-control form-control-sm" placeholder="Your Email" required>
                    <button type="submit" class="btn btn-success btn-sm px-3 fw-semibold">Join</button>
                </form>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start">
                <p class="text-white-50 small mb-0">&copy; 2026 E-Commerce Store. All Rights Reserved.</p>
            </div>
            <div class="col-md-6 text-center text-md-end mt-2 mt-md-0">
                <span class="text-white-50 small">Designed with PHP, Bootstrap & MySQL</span>
            </div>
        </div>
    </div>
</footer>
